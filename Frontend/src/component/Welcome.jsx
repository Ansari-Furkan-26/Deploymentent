...
function Welcome() {
  ...
  return (
    <div className="w-full h-screen bg-[#FAF5FF] p-5">
      <img className="rounded-3xl" src="https://i.pinimg.com/564x/a5/84/72/a5847287e8fee4cd9b769b472022bcae.jpg" alt="Image" />
      ...
      <Link to="/Register"><button className="bg-[#FFFFFF] rounded-2xl text-[#5B5B5E] py-7 px-12">Register</button></Link>
      <Link to="/Login"><button className=" text-[#979797] py-7 px-12">Sign in</button></Link>
      </div>
    </div>    
  );
}
